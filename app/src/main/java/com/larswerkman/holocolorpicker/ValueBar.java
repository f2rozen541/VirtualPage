...
//		mBarPointerPosition = mBarPointerHaloRadius;
        mBarPointerPosition = Math
                .round((mBarLength + mBarPointerHaloRadius));
...
//		mBarPointerHaloPaint.setAlpha(0x50);
		...
		mBarPointerPaint.setColor(0xff8000ff);
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		if (!isInEditMode()) {
			mBarPointerPosition = Math.round(((mSatToPosFactor * hsvColor[2])) + mBarPointerHaloRadius);
        } else {
			mBarPointerPosition = mBarPointerHaloRadius;
		}
	}
