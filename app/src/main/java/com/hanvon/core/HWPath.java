 ...
 * -------------------------------
 * Description:构造path。
 * 根据指定的点序列及压力值序列构造Path，提供addPoint，getBounds等方法。
 * -------------------------------
 */
public class HWPath {
    ...
    public boolean endPath() {
        ...
        if(size >= 1 && (mPoints.get(size - 1).x != com.hanvon.core.StrokeCollection.ENDPOINT.x
                || mPoints.get(size - 1).y != com.hanvon.core.StrokeCollection.ENDPOINT.y))
            return true;
    ...
    public int[] PointData() {
        if(mPts == null)
        {
            ...
            if(pt.x != com.hanvon.core.StrokeCollection.ENDPOINT.x && pt.y != com.hanvon.core.StrokeCollection.ENDPOINT.y)
            {
                mPoints.add(com.hanvon.core.StrokeCollection.ENDPOINT);
                size += 1;
            }
    ...
    public float[] PressureData() {
        if(mPressures == null) {
            ...
            if(mPrs.get(size - 1) != com.hanvon.core.StrokeCollection.ENDPRESSURE) {
                mPrs.add(com.hanvon.core.StrokeCollection.ENDPRESSURE);
                size += 1;
            }
    ...
    public void UpdateData(HWCanvas canvas) {
        ...
        if(mPoints.size()>0) {
            ...
            if(pt.x == com.hanvon.core.StrokeCollection.ENDPOINT.x && pt.y == com.hanvon.core.StrokeCollection.ENDPOINT.y) {
                mData.add(Float.valueOf(com.hanvon.core.StrokeCollection.ENDPOINT.x));
                mData.add(Float.valueOf(com.hanvon.core.StrokeCollection.ENDPOINT.y));
                mData.add(Float.valueOf(com.hanvon.core.StrokeCollection.ENDPRESSURE));
    ...
    public void updatePathData(float[] data, int[] rect) {
        ...
        mPathData[num] = com.hanvon.core.StrokeCollection.ENDPOINT.x;
        mPathData[num + 1] = com.hanvon.core.StrokeCollection.ENDPOINT.y;
        mPathData[num + 2] = com.hanvon.core.StrokeCollection.ENDPRESSURE;
     ...
     * @return    是否被擦除
     */
    public boolean IsOutlineVisible(Rect rc, com.hanvon.core.HWPen pen) {
        ...
        if(mPoints.size() >= 2) {
            ...
            while(x1 != com.hanvon.core.StrokeCollection.ENDPOINT.x && y1 != com.hanvon.core.StrokeCollection.ENDPOINT.y ) {
                x =  x1;
                y =  y1;
