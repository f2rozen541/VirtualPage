...
import com.hanvon.virtualpage.utils.BitmapLoadUtils;
import com.hanvon.virtualpage.utils.FastBitmapDrawable;
import com.hanvon.virtualpage.utils.RectUtils;
...
public class TransformImageView extends ImageView {
     ...
     */
    public float getMatrixValue(@NonNull Matrix matrix, @IntRange(from = 0, to = MATRIX_VALUES_COUNT) int valueIndex) {
