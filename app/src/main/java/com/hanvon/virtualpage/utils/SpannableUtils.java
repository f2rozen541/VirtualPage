...
public class SpannableUtils {
	...
	public static SpannableString setTextImg2( String content, int startIndex, int endIndex, int startIndex2, int endIndex2, Drawable drawable1,  Drawable drawable2 ){
		if( TextUtils.isEmpty( content ) || startIndex < 0 || endIndex >= content.length( ) || startIndex >= endIndex || startIndex2 < 0 || endIndex2 >= content.length( ) || startIndex2 >= endIndex2){

			return null;
		}
		
		SpannableString spannableString = new SpannableString( content );
		spannableString.setSpan(new ImageSpan(drawable1), startIndex, endIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		spannableString.setSpan(new ImageSpan(drawable2), startIndex2, endIndex2, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
